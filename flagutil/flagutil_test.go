...
func TestGetFlagValue(t *testing.T) {
	...
	fs.Parse([]string{"--test-flag", "value"})
...
func TestGetInt(t *testing.T) {
	...
	fs.Parse([]string{"--port", "8080", "--bad-port", "not-a-number"})
...
func TestGetInt64(t *testing.T) {
	...
	fs.Parse([]string{"--limit", "922337203685477580", "--bad-limit", "not-a-number"})
...
func TestGetUint(t *testing.T) {
	...
	fs.Parse([]string{"--size", "42", "--bad-size", "not-a-number"})
...
func TestGetUint64(t *testing.T) {
	...
	fs.Parse([]string{"--total", "184467440737095516", "--bad-total", "not-a-number"})
...
func TestGetFloat64(t *testing.T) {
	...
	fs.Parse([]string{"--ratio", "0.75", "--bad-ratio", "not-a-number"})
...
func TestGetBool(t *testing.T) {
	...
	fs.Parse([]string{"--enabled", "true", "--bad-bool", "maybe"})
...
func TestGetDuration(t *testing.T) {
	...
	fs.Parse([]string{"--timeout", "5s", "--bad-timeout", "invalid-duration"})
